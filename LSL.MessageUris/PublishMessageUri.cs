...
namespace LSL.MessageUris
{
    ...
    public class PublishMessageUri : UriWithOptionalQueryString
    {
        ...
        private static InnerParseResult InnerTryParse(string uri, out PublishMessageUri result)
        {
            ...
            {
                result = null;
                return new InnerParseResult(false, $"Expected a scheme of 'publish-message' but found '{realUri.Scheme}'");
            }
